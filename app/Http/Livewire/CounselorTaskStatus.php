...
class CounselorTaskStatus extends Component
{
...
// This method is called when the component is initialized
    public function mount(){
        ...
        $this->tasks = CounselorTask::all();
        $this->tasks = CounselorTask::orderBy('created_at', 'desc')->get();// sort created task on the descending order by created_at colunm
    ...
    {
        return view('livewire.counselor-task-status');
    }
}
