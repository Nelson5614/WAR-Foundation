    ...
    <div class="min-h-screen container mx-auto py-8 px-20 w-full">
        ...
        <div class=" min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto w-full ">
                <form class="space-y-6" action="{{ route('counselor-tasks.store') }}" method="POST">
                    @csrf
                    <div class=" grid md:grid-cols-2 md:gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="title" name="title" type="text" autocomplete="title" required class="pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        {{-- <div>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                ...
                <a href="{{ route('counselor-tasks.index') }}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Go Back</a>
            </p>
            </div>
        </div>
