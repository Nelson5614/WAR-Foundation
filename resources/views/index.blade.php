        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                Re Aha Bocha | We Are Rebuilding Foundation
              </h1>
              <p
                class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]"
              >
              Aims at helping students, particularly youth who deal with pressure from everyday events of life and
              to recover from traumatic experiences in order to rebuild their lives.
              </p>
              <ul
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mt-16">
                <img
                  src="assets/images/hero/home-img2.png"
                  alt="hero"
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                We believe in change, we believe in building again and we believe everyone should be given a chance.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4 lg:w-1/2">
              <div class="mb-12 max-w-[540px] lg:mb-0">
                ...
                >
                The organisation&#39;s main objective is to provide a conducive and supportive space for therapy to
                students at all levels of education. More especially to those who may be facing various challenges in
                their personal and academic lives like bulling, peer pressure or dealing with loss of a loved one. It
                also aims at helping the wider society, with a particular focus on those who are said to be the most
                stigmatised and vulnerable.
                  <br />
                  <br />
                  Most importantly, Re Aha Bocha | We are Rebuilding Foundation
                  strives at offering both individual and group counselling sessions at a low cost or free of charge,
                  depending on the nature and/or severity of the situation.
            ...
            <div class="w-full px-4 lg:w-1/2">
              <div class="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="./assets/images/about/image_4.jpg"
                      alt="about image"
                ...
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="./assets/images/about/image_03.jpg"
                      alt="about image"
                      class="object-cover object-center w-full h-full"
                    />
                  </div>
          ...
          <div class="flex flex-wrap items-stretch -mx-4">
            <div class="w-full px-4">
              <div class="mx-auto max-w-[570px] text-center">
                ...
                >
                  Complete the registration form and contact us immediately to book your session
                </p>
                <a
                  href="{{ route('register') }}"
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                This is what the students and other stake holders are saying about the work we do!
              </p>
            </div>
          </div>
        </div>
                ...
                @foreach ($testimonials as $testimonial)
                    <div class="swiper-slide">
                        ...
                        <a href="#" class="flex items-center gap-4">
                            ...
                            <p class="text-xs text-body-secondary">{{ $testimonial->occupation }}</p>
                            </div>
                        </a>
                        </div>
                    </div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[520px] text-center">
              ...
              >
               Check out some of our frequently asked questions below. dont hesitate to contact us if you dont find your answer below.Looking forward to hearing from you soon!
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                Here is the team behind making everything stand out at Re Aha Bocha Foundation
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="./assets/images/team/default.png"
                  alt="team image"
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                Check out our latest news and the places we have recently visited and lifes we have touched!
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".1s">
              ...
              <div>
                ...
                <h3>
                  ...
                  >
                    Our Visit At Lesotho High School
                  </a>
                </h3>
                <p
              ...
              <div class="flex flex-wrap justify-between mb-12 lg:mb-0">
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p class="text-base text-body-color dark:text-dark-6">
                        Olympic Building in Maseru,P. O. Box 1852, Maseru 100,
                    </p>
                  </div>
                </div>
                <div class="mb-8 flex w-[330px] max-w-full">
              ...
              <form>
                <div class="mb-[22px]">
                  ...
                  <input
                    type="text"
                    name="fullName"
                    placeholder="Itumeleng Mathebeng"
