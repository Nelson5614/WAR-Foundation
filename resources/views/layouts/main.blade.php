          ...
          <div class="relative flex items-center justify-between -mx-4">
            <div class="max-w-full px-4 w-60">
              <a href="{{ url('/') }}" class="block w-full py-5 navbar-logo">
                ...
                /> --}}
                <h1 class="font-bold text-white">RE AHA BOCHA</h1>
              </a>
            </div>
              ...
              <div>
                ...
                >
                  <ul class="blcok lg:flex 2xl:ml-20">
                    ...
                    <li class="relative lg:hidden group">
                        <a
                          href="{{ route('login') }}"
                          class="flex px-4 py-2 mx-8 mt-8 font-medium text-center bg-white rounded-md bg-opacity-20 hover:bg-opacity-100 hover:text-dark ud-menu-scroll text-dark group-hover:text-primary dark:text-white "
                        >
                          Sign In
                        </a>
    ...
    <footer
        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full mb-10">
                ...
                <h1 class="text-white">RE AHA BOCHA</h1>
                {{-- <img
                    src="assets/images/logo/logo-white.svg"
                    alt="logo"
                    class="max-w-full"
                ...
                We are dedicated to making the lives of our young people happy and easier!
                </p>
            ...
            <div class="w-full mb-10">
                ...
                >
                    ...
                    >
                    Our first carreer guidance workshop...
                    </span>
                </a>
                <a
                    href="blog-details.html"
