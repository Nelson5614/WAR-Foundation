                        ...
                        <div class="flex">
                            ...
                            <div class="px-1">
                                <div class=" mt-2">
                                    ...
                                    <a href="{{ route('counselor-tasks.edit', $task->id) }}" class="bg-green-700 py-2 px-2 text-white rounded-md">Edit</a>
                                </div>

                            </div>
                            <div class="px-1">
                                <form action="{{ route('counselor-tasks.destroy', $task->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
